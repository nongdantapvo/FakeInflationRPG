...
sub_screen = pygame.Surface((450, 450))
...
bg_surface = pygame.image.load('FakeInflationRPG/picture/background.png').convert()
battle_surface = pygame.image.load('FakeInflationRPG/picture/background-battle.jfif').convert()
# battle_surface = pygame.transform.scale(battle_surface, (500,500))

char_surface = pygame.image.load("FakeInflationRPG/picture/character.png").convert_alpha()
char_surface = pygame.transform.scale(char_surface, (50, 50))
char_rect = char_surface.get_rect(center = (500, 380))

mon_surface = pygame.image.load("FakeInflationRPG/picture/monster.png").convert_alpha()
...
while active:
    ...
    if pause_time > 0:
        ...
        if mon_rect.left < 0 or mon_rect.right > 1000 or mon_rect.top < 0 or mon_rect.bottom > 759:
            x_mov_mon = -x_mov_mon
            y_mov_mon = -y_mov_mon
            mon_rect.move_ip(x_mov_mon * 10, y_mov_mon * 10)
    ...
    if char_rect.colliderect(mon_rect):
        ...
        sub_screen.blit(mon_surface, mon_rect)
        screen.blit(sub_screen, sub_rect)
        # #hide monster
        # x_mov_mon += 1000
        # y_mov_mon += 1000
